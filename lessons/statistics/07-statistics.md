...
>> While frequentist statistics do not use probabilities to hypotheses or to unknown values, Bayesian statistics use probabilities to represent uncertainties in hypotheses.
