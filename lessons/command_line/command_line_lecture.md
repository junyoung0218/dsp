...
> Question: How could we make sure that we moved? Type pwd
...
would we do that? curl https://archive.ics.uci.edu/ml/machine-learning-databases/auto-mpg/auto-mpg.data > data.txt
